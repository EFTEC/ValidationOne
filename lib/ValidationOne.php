...
class ValidationOne
{
	...
	private $type='string';
	private $types=[];
	/** @var int=[0,1,2,3,4][$i] 0=number,1=string,2=date,3=boolean,4=file */
	private $typeFam=1;
	private $typeFams=1;
	 ...
	 *      <b>string</b>:req,eq,ne,minlen,maxlen,betweenlen,null,notnull,contain,notcontain,alpha,alphanum,text,regexp,email,url,domain<br>
